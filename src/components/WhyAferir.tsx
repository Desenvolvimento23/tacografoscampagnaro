            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow text-center">
                        ...
                        <h3 className="text-xl font-bold mb-4 text-secondary">Legalidade</h3>
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow text-center">
                        ...
                        <h3 className="text-xl font-bold mb-4 text-secondary">Veículos Obrigatórios</h3>
                        <p className="text-gray-600">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow text-center">
                        ...
                        <h3 className="text-xl font-bold mb-4 text-secondary">Riscos</h3>
                        <p className="text-gray-600">
